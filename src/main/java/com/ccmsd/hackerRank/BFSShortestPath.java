...
public class BFSShortestPath {
	...
	public static Graph1 constructGraph()
	{		
	...
	public static ArrayList<Integer> doBFSShortestPath(Graph1 graph, int source, int dest)
	{
